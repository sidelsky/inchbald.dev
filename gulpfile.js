...
gulp.task("spriteBase", function() {
    var spriteData = gulp.src(src + "/img/pngs/*.png").pipe(
        spritesmith({
...
gulp.task("spriteCss", ["spriteBase"], function() {
    return gulp
        .src(src + "/sass/_sprites.scss")
        .pipe(
            replace(
                "../../public/wp-content/themes/" + theme + "/assets/build/",
                ""
            )
        )
...
gulp.task("watch", function() {
    ...
    gulp
        .watch(root + "/wp-content/themes/" + theme + "/**/*.php")
